...
typedef void (*pTypeRotaryCallback)(void);
...
/**
 * Sets a function (Rotary press) to be called when the timer fires.
 *
...
/**
 * Sets a function (rotary rotation) to be called when the timer fires.
 *
 * @param cb  pointer to the callback function; if NULL, no callback
 *            will be executed.
 */
